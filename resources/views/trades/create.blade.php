...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold text-gray-800">🔄 Record Trade</h1>
...
<div class="max-w-2xl p-6 bg-white shadow rounded-xl">
    <form method="POST" action="{{ route('trades.store') }}">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                <label class="block mb-1 text-sm font-medium text-gray-700">New Owner *</label>
                <select name="to_owner_id"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                        required>
